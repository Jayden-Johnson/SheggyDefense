...
namespace MBS.Model.Configuration
{
    public class PathsManager
    {
        ...
        private void PathsHealthCheck( )
        {
            ...
            var isInternalValid = AssetDatabase.IsValidFolder( _internalDataPath );
            ...
            if ( !isPacksValid )
            {
                ...
                if ( string.IsNullOrEmpty( result ) )
                    throw new Exception( string.Format( Texts.Configuration.PathsManager.CANT_CREATE_FOLDER,
                                                        _modularPackPath ) );
            }
