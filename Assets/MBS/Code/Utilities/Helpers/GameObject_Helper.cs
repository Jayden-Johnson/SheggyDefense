...
namespace MBS.Utilities.Helpers
{
    public static class GameObjectHelper
    {
        ...
        /// <summary>
        ///     Trying to get prefab preview texture in try-get/then-wait cycle with limited iterations number.
        /// </summary>
        /// <returns>
        ///     If succeed returns the prefab preview texture, otherwise returns null
        /// </returns>
        public static Texture2D GetPreviewTexture( GameObject prefab )
        {
            //Check all wrong conditions
