...
{
    internal static class Picker_Mode
    {
        ...
        internal static SceneFuncData DoPickerMode( Event e )
        {
        ...
        internal static void Setup_Inputs( Action<float> mouseClickAction )
        {
            ...
            InputManager.AddKeyElement( new UIDropdownElement( )
            {
