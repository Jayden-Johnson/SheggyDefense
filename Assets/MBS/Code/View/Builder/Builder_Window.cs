...
namespace MBS.View.Builder
{
    public class Builder_Window : EditorWindow
    {
        ...
        internal static Builder_Window Instance { get; private set; }
        ...
        internal void Launch( ToolbarTool tool, List<string> packsNames )
        {
            IsRunning = true;
        ...
        private void ConfigureGridSizeRow( )
        {
            ...
            {
                // Controller will check the lock toggle
                // In case of anything controller will return proper value
                ...
                // on input value manually 
                // reset the grid cell size lock toggle
                _gridSizeLinkToggle.value = false;
            ...
            _gridSizeLinkToggle.RegisterValueChangedCallback( e =>
            {
                ...
                if ( e.newValue ) _gridSizeFloatField.SetValueWithoutNotify( gridCellSize );
            } );

            _gridSizePickerToggle.RegisterValueChangedCallback( e =>
            {
                if ( e.newValue )
                    Builder_Controller.ChangeSceneMode( SceneMode.Picker, ChangingGridParam.GridCellSize );
                else
        ...
        private void ConfigureLevelHeightRow( )
        {
            ...
            {
                if ( e.newValue )
                    Builder_Controller.ChangeSceneMode( SceneMode.Picker, ChangingGridParam.LevelHeight );
                else
                    Builder_Controller.ChangeSceneMode( SceneMode.Builder );
            } );
        }
        ...
        private void ConfigureIMGUIContainer( )
        {
            ...
            {
                var selectedGroupSize =
                    Builder_Controller.ShowSelectionGrid( (int)position.width, (int)position.height );

                if ( selectedGroupSize > -1 ) _gridSizeFloatField.value = selectedGroupSize;
            };
        }
        ...
        internal void SetupToolData( ToolbarTool tool, ToolData toolData )
        {
