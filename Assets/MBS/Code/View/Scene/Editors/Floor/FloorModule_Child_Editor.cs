    ...
    public class FloorModule_Child_Editor : Editor
    {
        ...
        private void OnEnable( )
        {
            ...
            if ( _isMultiple == false )
            {
                ...
                // _bothComponentsAttached = targetObject.gameObject.GetComponent<MBSPlacerModule>( );
            ...
            else
            {
                ...
                // _bothComponentsAttached = targetsCasted.All( i => i.GetComponent<MBSPlacerModule>( ) != null );
                // if ( _bothComponentsAttached )
                //     return;
