...
namespace MBS.Controller.Scene
{
    ...
    {
        internal static GameObject CreatePlaneMesh( Vector3[ ] areaPoints, WindingOrder pointsWindingOrder )
        {
            ...
            gameObject.GetComponent<MeshFilter>( ).mesh = Object.Instantiate( planeMesh );
            gameObject.transform.position = center;
            gameObject.GetComponent<MeshRenderer>( ).sharedMaterial =
                Object.Instantiate( InternalDataManager.Singleton.CheckboardMaterial );
            return gameObject;
        }
        ...
        internal static List<int> GetIndexList( int listLength )
        {
        ...
        internal static float GetAngleBetweenPoints( Vector3 prevPoint, Vector3 midPoint, Vector3 nextPoint )
        {
