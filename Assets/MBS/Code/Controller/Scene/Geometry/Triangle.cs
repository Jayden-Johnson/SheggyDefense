...
namespace MBS.Controller.Scene
{
    ...
    internal class Triangle : GeometryShape
    {
        ...
        internal Triangle( Vector3 a, Vector3 b, Vector3 c )
        {
        ...
        internal float CalcTriangleArea( Vector3 p1, Vector3 p2, Vector3 p3 )
        {
        ...
        internal (bool isInside, bool isEdge) IsPointInside( Vector3 point )
        {
        ...
        internal bool IsTriangleInside( Triangle triangle )
        {
        ...
        internal void AddIntersectedTriangle( Triangle triangle )
        {
