...
namespace MBS.Controller.Scene
{
    ...
    internal class MBSConstruction : MonoBehaviour
    {
        ...
        [NonSerialized] internal Vector3[ ] additionalPointsToDraw;

        internal static MBSConstruction Current
        {
            get
            {
                if ( _sCurrent == null )
        ...
        internal List<RoomArea> Areas => _areas;
        ...
        internal void StartEditObject( )
        {
            Initialize( );
            Builder_Controller.Launch( this );
        }

        internal bool IsWallAlreadyAdded( MBSWallModule wall )
        {
        ...
        internal void AddWallAndConnect( MBSWallModule mbsWallModule )
        {
        ...
        internal void RemoveWallAndDisconnect( MBSWallModule mbsWallModule, bool doUpdateMesh = false )
        {
        ...
        internal void AddArea( RoomArea area )
        {
            _areas.Add( area );
        }

        internal void RemoveAreasWithWall( MBSWallModule mbsWallModule )
        {
        ...
        internal void AddAreasIfFound( MBSWallModule mbsWallModule )
        {
        ...
        internal RoomArea[ ] FindAreasWith( MBSWallModule mbsWallModule )
        {
            RoomArea[ ] areas;
        ...
        internal bool TryFindEndPointToSnap( Vector3 constrPointNotSnapped, Vector3 constrPointSnapped, float radius,
        ...
        // public static RoomArea GetAreaAtPoint( Vector3 point_Constr, List<RoomArea> areas )
        // {
        ...
        //         if ( areas[ i ].IsPointInsideArea( point_Constr ) )
