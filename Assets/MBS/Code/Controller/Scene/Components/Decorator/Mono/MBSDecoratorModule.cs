...
{
    internal class MBSDecoratorModule : MonoBehaviour
    {
        [Serializable]
        internal class PlacerAssetData
        {
        ...
        internal PlacerAssetData Data => _data;
        ...
        internal DecoratorGroup OrigGroup
        {
            get
            {
                if ( _origGroup != null )
        ...
        internal DecoratorModule OrigModule
        {
            get
            {
                if ( _origGroup != null )
        ...
        internal MBSDecoratorModule ChangeModule( DecoratorModule newModule, bool isMultipleChange )
        {
        ...
        internal void WhenPlaced( ModularPack pack, ModularGroup group, Module module )
        {
            _origPack = pack;
        ...
        internal void WhenChanged( PlacerAssetData data, DecoratorModule module )
        {
            _data = new PlacerAssetData( )
            {
