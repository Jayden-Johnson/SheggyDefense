...
{
    internal enum DecoratorRotationAxis
    {
        YAxis,
        XAxis,
        ZAxis
    ...
    internal enum RotationSnapStep
    {
        Ninety,
        Fifteen,
        One,
    ...
    internal static class Decorator_RotationMode
    {
        internal static string[ ] AxisTextArray = { "Y Axis", "X Axis", "Z Axis" };
        internal static float[ ] SnapStepValueArray = { 90.0f, 15.0f, 1.0f, 0.1f };
        ...
        internal static DecoratorRotationAxis Axis;
        internal static RotationSnapStep SnapStep;
        internal static Space RotationSpace;

        internal static bool DoSnapRotation;

        internal static Quaternion initialRotation;
        internal static Vector3 initialExtents;


        internal static void Start( Transform transform, Bounds worldBounds )
        {
            initialRotation = transform.rotation;
            initialExtents = worldBounds.extents;
        }

        internal static void Run( Transform transform, Bounds worldBounds )
        {
