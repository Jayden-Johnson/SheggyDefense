...
{
    internal static class Wall_LoopFinder
    {
        internal static List<RoomArea> FindLoops( MBSWallModule startMbsWallModule )
        {
                                       ...
                                       List<RoomArea> allAreas )
        {
            ...
            //PlaceDebugObjAt( 0.3f, propagateData.constrFrontEndPoint, visitedPoints.Count.ToString( ) );
            visitedWalls.Add( currentMbsWallModule );
            visitedPoints.Add( propagateData.ConstrBackEndPoint );
