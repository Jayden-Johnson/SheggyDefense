...
namespace MBS.Controller.Scene
{
    ...
    public class Wall_MeshModifier
    {
        ...
        public static Mesh ModifyMesh( MBSWallModule mbsWallModule, MBSWallModuleModifier moduleModifier )
        {
            ...
            if ( hasVertexColors )
            {
                ...
                for ( var v = 0; v < vertices.Length; v++ )
                {
                    ...
                    //There we're calculating the amount of offset that we should apply to the corners vertices
                    //Different calculations for different angles
        ...
        /// <param name="localPoint"> Point in wall local space</param>
        /// <param name="vertecies"> Mesh vertecies to comapare distances and return index</param>
        ...
        internal static void ScaleWall( MBSWallModule mbsWallModule, Vector3 scaleVector )
        {
        ...
        internal static Mesh ScaleMesh( Mesh originalMesh, Vector3 scaleVector )
        {
            if ( originalMesh == null )
            {
                Debug.LogError( Texts.Building.WallMeshModifier.ORIGINAL_MESH_MISSING );
