...
namespace MBS.Controller.Scene
{
    public static class Gizmos_Controller
    {
        ...
        internal static bool DefaultOrAccent;

        internal static Vector3 ObjBoundsSize;
        internal static LeadAxis LearAxis;
        ...
        internal static void SetupMesh( Mesh mesh )
        {
            Mesh = mesh;
        }


        internal static void SetupMeshDrawFunction( )
        {
            _currentDrawAction = DrawMesh;
        }

        internal static void SetupPickerDrawFunction( )
        {
        ...
        internal static void SetupPointerDrawFunction( )
        {
        ...
        internal static void SetWallData( float height )
        {
